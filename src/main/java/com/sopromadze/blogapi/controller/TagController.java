...
public class TagController {
    ...
    public ResponseEntity<Tag> addTag(@RequestBody @Valid TagRequest tagRequest, @CurrentUser UserPrincipal currentUser){
        Tag newTag = tagService.addTag(tagRequest, currentUser);
    ...
    public ResponseEntity<Tag> updateTag(@PathVariable(name = "id") Long id, @RequestBody @Valid TagRequest tagRequest, @CurrentUser UserPrincipal currentUser){

        Tag updatedTag = tagService.updateTag(id, tagRequest, currentUser);
