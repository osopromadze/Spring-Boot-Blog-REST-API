...
public class TodoController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<Todo> addTodo(@RequestBody @Valid TodoRequest todoRequest, @CurrentUser UserPrincipal currentUser){
        Todo newTodo = todoService.addTodo(todoRequest, currentUser);
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<Todo> updateTodo(@PathVariable(value = "id") Long id, @RequestBody @Valid TodoRequest todoRequest, @CurrentUser UserPrincipal currentUser){
        Todo updatedTodo = todoService.updateTodo(id, todoRequest, currentUser);
