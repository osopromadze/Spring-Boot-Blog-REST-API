...
public class CategoryServiceImpl implements CategoryService {
	...
	@Override
	public ResponseEntity<Category> addCategory(CategoryRequest categoryRequest, UserPrincipal currentUser){
        Category newCategory =  categoryRepository.save(new Category(categoryRequest.getName()));
        return new ResponseEntity<>(newCategory, HttpStatus.CREATED);
    }

	@Override
	public ResponseEntity<Category> updateCategory(Long id, CategoryRequest categoryRequest, UserPrincipal currentUser) throws UnauthorizedException {
        Category category = categoryRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Category", "id", id));
